 ...
 * In you opinion, how can the inclusion of more taxa in the analyses influence these statistics?

 **2. Infered species tree** 
...
Now, let's download it ```Analyses/Orthology_Inference/Results_Mar29/Species_Tree/SpeciesTree_rooted``` and open it with **Figtree**. Remember that *H.robusta* is our outgroup. 
