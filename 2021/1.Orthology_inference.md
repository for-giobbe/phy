...
**NB** the ```-o``` optuon will create a new output directory inside /Analyses. Kill the process, it will take to much time (almost 10 hours with 10 cores). A ready-to-use output folder is /Analyses/Orthology_Inference 
