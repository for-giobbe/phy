...
If we have time, what can we do to improve our phylogeny? Well a lot of things can be done.
  ...
  * **4.** We can calculates the partition log-likelihood and try to remove partitions that are strongly driven our topology (be carefull you can also get worst results).
