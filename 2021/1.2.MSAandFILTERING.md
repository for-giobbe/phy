...
Lastly, we should move our final alignments in the ```Analyses/1-to-1_Alignments/gblock``` folder (being organized in the management of files/folders is **essential** when we are analyzing a lot of data):
