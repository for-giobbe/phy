 ...
 * **Prequal** (very interesting 2x since it masks non-homologous regions **BEFORE** alignments, see [Whelan et al., 2018](https://pubmed.ncbi.nlm.nih.gov/29868763/))
 * **TrimAl** (an evergreen like Bblock; [http://trimal.cgenomics.org/])
