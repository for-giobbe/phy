...
This method is able to incorporate structural alignments with the MAFFT tool. In brief, it querys a web-based Database of Aligned Structural Homologs (DASH) with input sequences and Homologs with structural information are added to the alignment, driving it.
