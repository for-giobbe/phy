...
> Remember that we have only **2x Gasteropoda**, **3x Bivalvia**, **1x Cephalopoda**, **1x Poliplacophora**, **1x Anellidae** (as outgroup). See [here](https://github.com/for-giobbe/phy/blob/master/2021/0.WorkingDirectory_Dataset.md) for taxonomy of our samples.
